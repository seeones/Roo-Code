	...
	if (typeof vscode.workspace.onDidChangeConfiguration === "function") {
		context.subscriptions.push(
			vscode.workspace.onDidChangeConfiguration((e) => {
				if (
					e.affectsConfiguration(`${Package.configPrefix}.debugProxy.enabled`) ||
					e.affectsConfiguration(`${Package.configPrefix}.debugProxy.serverUrl`) ||
					e.affectsConfiguration(`${Package.configPrefix}.debugProxy.tlsInsecure`)
				) {
