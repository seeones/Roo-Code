...
describe("useMcpToolTool", () => {
	...
	let mockRemoveClosingTag: ReturnType<typeof vi.fn<(tag: string, value?: string) => string>>
	...
	beforeEach(() => {
		...
		mockRemoveClosingTag = vi.fn<(tag: string, value?: string) => string>((tag, value) => value || "")
